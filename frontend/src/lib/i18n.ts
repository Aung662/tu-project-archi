...
export const t = {
  ...
  navWiring: L('ချိတ်ဆက်ပုံများ', 'Wiring'),
  ...
  wiringSubtitle: L(
    'Arduino နှင့် sensor / LCD / module များ ချိတ်ဆက်ပုံ အားလုံးကို တစ်နေရာတည်းတွင် — pin-to-pin ဇယားနှင့် ပုံအတိုင်း ဆက်သွယ်နိုင်သည်။',
    'Every Arduino ↔ sensor / LCD / module connection in one place — pin-to-pin tables and diagrams you can follow directly.',
  ),
  ...
  wiringViewDiagram: L('ချိတ်ဆက်ပုံ', 'Diagram'),
  ...
  cmpTitle: L('ကွန်ပိုနင့် နှိုင်းယှဉ်', 'Compare components'),
  cmpOpen: L('နှိုင်းယှဉ်ကြည့်ရန်', 'Compare'),
  cmpClear: L('ရှင်းမည်', 'Clear'),
  cmpAdd: L('နှိုင်းယှဉ်ရန် ထည့်မည်', 'Add to compare'),
  cmpAdded: L('နှိုင်းယှဉ်ရန် ထည့်ပြီး', 'In compare'),
  cmpFull: L('အများဆုံး ၃ ခုသာ', 'Max 3 items'),
  favAdd: L('အကြိုက်ဆုံး ထည့်ရန်', 'Add to favourites'),
  favAdded: L('အကြိုက်ဆုံး ထဲ ရှိပြီး', 'Favourited'),
  favOnly: L('အကြိုက်ဆုံးများသာ', 'Favourites only'),
  bomExport: L('ပစ္စည်းစာရင်း (CSV) ထုတ်ရန်', 'Export parts list (CSV)'),
  bomHint: L(
    'မှတ်ထားသော ပစ္စည်းများကို ဈေးနှုန်းခန့်မှန်းချက်နှင့်အတူ CSV အဖြစ် ထုတ်ယူ၍ ဝယ်ယူရန် စာရင်းအဖြစ် သုံးနိုင်သည်။',
    'Export your starred parts (with price estimates) as a CSV to use as a shopping / bill-of-materials list.',
  ),
  favEmpty: L('အကြိုက်ဆုံး ကွန်ပိုနင့် မရှိသေးပါ — ★ ကို နှိပ်၍ ထည့်ပါ', 'No favourite components yet — tap ★ to add some'),
  ...
  guideWhatFor: L('ဒါက ဘာလဲ? ဘာအတွက်လဲ?', 'What is it? What is it for?'),
  guideUseCases: L('ဘယ်နေရာတွေမှာ သုံးနိုင်လဲ?', 'Where can you use it?'),
  guidePinout: L('ဘယ်လို ချိတ်ဆက်မလဲ? (Pinout)', 'How do you connect it? (Pinout)'),
  guidePinCol: L('Pin', 'Pin'),
  guidePinDescCol: L('ဖော်ပြချက်', 'Description'),
  guideWiring: L('ချိတ်ဆက်ရာတွင် သတိပြုရန်', 'Wiring note'),
  guideWiringDiagram: L('ဘယ်လို ဝါယာဆက်မလဲ? (Diagram)', 'How do you wire it? (Diagram)'),
  guideWiringAuto: L(
    '* pinout ဒေတာမှ အလိုအလျောက် ထုတ်ထားသော နမူနာ ချိတ်ဆက်ပုံ — datasheet နှင့် code ထဲက pin နံပါတ်များနှင့် တိုက်စစ်ပါ။',
    '* Example wiring auto-generated from the pinout data — always confirm against the datasheet and the pin numbers in your sketch.',
  ),
  guideCode: L('ဘယ်လို သုံးမလဲ? (Test Code)', 'How do you use it? (Test code)'),
  guideCodeCopy: L('ကုဒ် ကူးရန်', 'Copy code'),
  guideCodeCopied: L('ကူးပြီး', 'Copied!'),
  guideCodeDownload: L('ဖိုင် ဒေါင်းရန်', 'Download file'),
  guideCodeHint: L(
    'ဤ test code ကို ကူးယူ (သို့) ဖိုင်အဖြစ် ဒေါင်းပြီး Arduino IDE / editor ထဲ တိုက်ရိုက် ဖွင့်နိုင်သည်။',
    'Copy this test code or download it as a file to open directly in the Arduino IDE / your editor.',
  ),
  guidePrice: L('ဈေးနှုန်း ဘယ်လောက်လဲ?', 'How much does it cost?'),
  guideAlternatives: L('အစားထိုးနိုင်သည့် အရာများ', 'What can you use instead?'),
  guideCautions: L('ဘာတွေ သတိထားရမလဲ?', 'What should you watch out for?'),
  guideLibraries: L('ဘယ် Library သုံးရမလဲ?', 'Which libraries do you need?'),
  ...
  exportLabel: L('Export', 'Export'),
  exportPdf: L('Thesis Card (PDF)', 'Thesis card (PDF)'),
  exportQr: L('QR ကုဒ် (PNG)', 'QR code (PNG)'),
  exportBusy: L('ထုတ်နေသည်…', 'Generating…'),
  recentSearches: L('မကြာသေးမီက ရှာခဲ့သည်', 'Recent searches'),
  recentSearchesClear: L('ရှင်းမည်', 'Clear'),
  ...
  aBulkImport: L('⬆ CSV တင်သွင်း', '⬆ Bulk import'),
  aBulkTitle: L('CSV / Excel မှ အစုလိုက် တင်သွင်းခြင်း', 'Bulk import from CSV'),
  aBulkTemplate: L('နမူနာ template ဒေါင်းလုဒ်', 'Download template'),
  aBulkChoose: L('CSV ဖိုင် ရွေးပါ', 'Choose CSV file'),
  aBulkValidate: L('စစ်ဆေးမည် (Dry-run)', 'Validate (dry-run)'),
  aBulkImportNow: L('တင်သွင်းမည်', 'Import now'),
  aBulkClose: L('ပိတ်မည်', 'Close'),
  aBulkRows: L('စာကြောင်း', 'rows'),
  aBulkOk: L('အောင်မြင်', 'ok'),
  aBulkFail: L('မအောင်မြင်', 'failed'),
  aBulkCreated: L('ဖန်တီးပြီး', 'created'),
  aBulkHint: L(
    'ကော်လံများ: title, abstract, keywords, year, level, authorsText, supervisorName, university, department, priceMmk, status, hasConsent — university ကို shortName ဖြင့်၊ department ကို code ဖြင့် ရေးပါ။',
    'Columns: title, abstract, keywords, year, level, authorsText, supervisorName, university, department, priceMmk, status, hasConsent — reference university by shortName and department by code.',
  ),
