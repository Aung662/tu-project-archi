    ...
    <header className="sticky top-0 z-40 border-b border-slate-200 bg-white/90 backdrop-blur">
      <nav className="mx-auto flex h-16 max-w-6xl items-center justify-between px-4">
        <div className="flex items-center gap-6">
          <button onClick={onLogoClick} title="TU Project Archive" className="flex items-center gap-2 text-left">
            ...
            <span className="hidden sm:block">
              <span className="block text-sm font-bold leading-tight text-slate-900">{t.brandTitle.my}</span>
              <span className="block text-[11px] leading-tight text-slate-500">{t.brandSubtitle.my}</span>
            </span>
          </button>
        ...
        <button
          ...
          className="grid h-10 w-10 place-items-center rounded-lg border border-slate-300 text-slate-700 sm:hidden"
        >
