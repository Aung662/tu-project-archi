 ...
 */
/**
 * The minimal shape a citation needs. Both `ProjectCard` and the lighter
 * bookmark-project object satisfy this, so citations work from either.
 */
...
function institution(p: Citable): string {
...
export function formatCitation(p: Citable, style: CitationStyle): string {
